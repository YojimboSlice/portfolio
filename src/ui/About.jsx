    ...
    <Tilt className="xs:w-[250px] w-full">
      ...
      >
        <div
          ...
          className="bg-neutral rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col"
        >
          <img src={icon} alt={title} className="w-16 h-16 object-contain" />
          <h3 className="text-stone-50 text-[20px] font-bold text-center">
            {title}
          </h3>
        </div>
      </motion.div>
